...
This directory contains all agent prompts for the DemoSwarm pack. Each agent is a narrow specialist with a single responsibility.
...
**Model naming rule:** Use model _names_ only (Haiku, Sonnet, Opus). No version numbers—they become stale.
