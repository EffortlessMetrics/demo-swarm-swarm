...
If running `/flow-5-deploy` on an existing run-id:
...
**If upstream artifacts are missing**: Flow 5 can start without Flow 4. Proceed best-effort: document assumptions, set status to UNVERIFIED, and continue.
