...
- Non-goal: acting as the publish gate for secrets. `secrets-sanitizer` is the publish gate later in the flow. You still flag _suspected secrets in code_ as a security finding.
...
_Findings requiring remediation:_
