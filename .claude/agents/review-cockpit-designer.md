...
```markdown
[Summary](#summary) | [Evidence](#evidence-panel) | [Hotspots](#hotspots) | [Recommendation](#recommendation)
```
...
- **Use jump links** at the top for keyboard navigation
- **Use meaningful icons** (✅, ⚠️, ❌) paired with text for status
