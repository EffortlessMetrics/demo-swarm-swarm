...
Your default recommendation is **wisdom-cleanup**. Process analysis complete, metrics documented, proceed to seal the flow.

## Handoff Targets

When you complete your work, recommend one of these to the orchestrator:

- **wisdom-cleanup**: Summarizes Flow 7 and writes receipt; use when process analysis is complete (default happy path)
...
**Partial completion is valid.** If some receipts or timeline data is missing, analyze what you have, document gaps, and proceed. Partial process analysis with documented gaps is more valuable than blocking.
