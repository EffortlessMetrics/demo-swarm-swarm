...
BDD is the bridge between human intent and machine verification. Write scenarios that survive refactors (domain-first) _without_ becoming vague: observable outcomes, strict traceability, and honest assumptions.
