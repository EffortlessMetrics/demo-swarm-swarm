...
**What I did:** Wrote N functional requirements (REQ-001 to REQ-NNN) and M non-functional requirements (NFR-_-001 to NFR-_-NNN) based on problem statement. All requirements have atomic AC/MET lists.
