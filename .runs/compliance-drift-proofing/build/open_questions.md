...
- Assumption: Overlapping check IDs across modules (drift.rs vs flow.rs) is acceptable by design.
  ...
  - Linked question: OQ-BLD-003, OQ-BLD-005

- Assumption: PLN/BLD abbreviations are definitively canonical (resolves OQ-PLN-004 and OQ-SIG-002).
  ...
  - Linked question: OQ-PLN-004, OQ-SIG-002
...
- A: PLN/BLD is the canonical OpenQ prefix format (resolves OQ-PLN-004 and OQ-SIG-002) [RESOLVED]
